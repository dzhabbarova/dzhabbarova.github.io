oSpP = false;
var oSpPOptions = {
    sAppUrl:"https://dzhabbarova.github.io",   // сайт клиента
    sAppUrlShow:"https://dzhabbarova.github.io",
    sOrigUrl:"https://dzhabbarova.github.io",
    sOrigFFUrl:"https://dzhabbarova.github.io",
    ...
    sAppKey:'79d8f6c017d0505215adf568f3ef787a',
    ...
    prompt_title:"Подписка на уведомления1",
    prompt_text:"Разрешите сайту dzhabbarova.github.io отправлять вам уведомления на рабочий стол1",
    prompt_description:"-",
    currentDB:null,
    parentEvent:null,
    initedPage:false,
    ...
    sVapidPublicKey: 'BD3XcrLnkttejU34yoqI2v2eLNk5sQ7E7OSWk7FNHmPfE0dDUgzWhzmsm73J76r6D7HGh4karzsholg_x9MZOkc'
};
                            ...
                            navigator.serviceWorker.getRegistrations().then(function(registrations) {
                                ...
                                for (var i=0; i<registrations.length; i++) {
                                    if (
                                        ...
                                        ||
                                        (registrations[i].active.scriptURL.indexOf('serviceworker.js') != -1)
                                        ||
                                        (registrations[i].active.scriptURL.indexOf('sp-push-worker-fb.js') != -1)
                                    ) {
